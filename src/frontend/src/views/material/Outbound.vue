      ...
      <ElTableColumn label="操作" width="150" fixed="right">
        <template #default="scope">
          <div class="action-buttons">
            <ElButton size="small" @click="form = { ...(scope.row as MaterialOutbound) }; dialogVisible = true">编辑</ElButton>
            <ElButton size="small" type="danger" @click="handleDelete((scope.row as MaterialOutbound).id!)">删除</ElButton>
          </div>
        </template>
      </ElTableColumn>
    </ElTable>
